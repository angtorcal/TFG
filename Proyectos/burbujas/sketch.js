...
var system = {
  ...
  /*
  shape: {
    circle: ellipse(5, 5, 2, 2),
    square: rect(5, 5, 2, 2),
    triangle: ngon(3, 2, 2, 1),
    pentagon: ngon(5, 3, 3, 2),
    star: star(6, 2, 2, 1 / sqrt(3), 1)
  },
  */
  gravity: {
    direction: 90,
...
/*
var f_s = gui.addFolder('shape');
f_s.open();
f_s.add(system.shape, "circle");
f_s.add(system.shape, "square");
f_s.add(system.shape, "triangle");
f_s.add(system.shape, "pentagon");
f_s.add(system.shape, "star");
*/
